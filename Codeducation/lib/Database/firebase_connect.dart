...
class FlutterConnection {
  ...
  static FlutterConnection get instance => _instance ??= FlutterConnection._internal();
  ...
  static const String _databaseUrl = 'https://codeducation-dee0d-default-rtdb.firebaseio.com';
  ...
  FirebaseDatabase get database {
    if (_database == null) {
      ...
      if (Firebase.apps.isEmpty) {
        throw Exception('Firebase başlatılmamış. Lütfen Firebase.initializeApp() çağırın.');
      }

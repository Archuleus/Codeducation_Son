...
class _AuthScreenState extends State<AuthScreen> with TickerProviderStateMixin {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'tr': {
      ...
      'joinFun': 'Eğlenceye Katıl!',
      'eduMissed': 'Edu seni özledi! Öğrenmeye devam edelim!',
      'startJourney': 'Harika öğrenme yolculuğuna başlayalım!',
      'yourName': 'Adın',
      'email': 'E-posta',
      'password': 'Şifre',
      'rememberMe': 'Hesabımı açık tut',
      'letsLearn': 'Hadi Öğrenelim!',
      ...
      'signUp': 'Kayıt Ol',
      'signIn': 'Giriş Yap',
      'enterName': 'Lütfen adını gir',
      'nameLength': 'Ad en az 2 karakter olmalı',
      'enterEmail': 'Lütfen e-postanı gir',
      'validEmail': 'Lütfen geçerli bir e-posta gir',
      'enterPassword': 'Lütfen şifreni gir',
      'passwordLength': 'Şifre en az 6 karakter olmalı',
      'welcomeBackMsg': 'Tekrar hoş geldin!',
    ...
    'en': {
      ...
      'eduMissed': 'Edu missed you! Let\'s continue learning!',
      'startJourney': 'Let\'s start your amazing learning journey!',
      'yourName': 'Your Name',
      'email': 'Email',
      'password': 'Password',
  ...
  String _getText(String key) =>
      _translations[isTurkish ? 'tr' : 'en']?[key] ?? key;
...
// Ayrıca _navigateToHome metodunu da güncelleyin:
  void _navigateToHome() {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'Zaten giriş yapmışsınız! Ana sayfaya yönlendiriliyorsunuz...'),
  ...
  bool _canChangeLanguage() {
    ...
    return DateTime.now().difference(_lastLanguageChange!) >=
        _languageChangeLimit;
  }
  ...
  LinearGradient _buildBackgroundGradient() {
    ...
    final currentPair = gradientStops[
        (_backgroundAnimation.value * gradientStops.length).floor() %
    ...
    return LinearGradient(
      ...
      colors: [
        Color.lerp(
            currentPair[0], currentPair[1], _backgroundAnimation.value * 0.3)!,
        Color.lerp(
            currentPair[1], currentPair[0], _backgroundAnimation.value * 0.3)!,
        Color(0xFF1a1a1a),
      ],
      stops: [0.0, 0.5, 1.0],
    );
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              ...
              children: [
                _buildAnimatedText(isTurkish ? '🇹🇷' : '🇺🇸',
                    ValueKey(isTurkish), TextStyle(fontSize: 18)),
                SizedBox(width: 8),
                _buildAnimatedText(
                    isTurkish ? 'TR' : 'EN',
  ...
  Widget _buildNameField() => _buildTextField(
        ...
        validator: (value) {
          if (value?.isEmpty ?? true) return _getText('enterName');
          if (value!.trim().length < 2) return _getText('nameLength');
          return null;
        },
      );
      ...
      child: TextFormField(
        ...
        inputFormatters: [
          FilteringTextInputFormatter.allow(
              RegExp(r'[a-zA-ZçÇğĞıİöÖşŞüÜ0-9@._\-\s]')),
        ],
